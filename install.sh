...
log "  • Set git identity: cp docs/gitconfig.local.example ~/.gitconfig.local && \$EDITOR ~/.gitconfig.local"
log "  • Machine-local env: create ~/.bashrc.local for host-specific overrides"
